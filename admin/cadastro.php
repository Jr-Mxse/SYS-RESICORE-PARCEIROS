        ...
        <div class="login_left">
            <div class="login_content">
                ...
                <form class="login_form" name="work_login" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form_group">
                        <label class="form_label">
                            <span class="label_text" style="margin-bottom: 1.3rem">Atendimento realizado por qual especialista?</span>
                    ...
                    <div class="form_group">
                        <div class="label_50">
                            <div class="form_group">
                                <label class="form_label">
                                    <span class="label_text" style="margin-bottom: 1.3rem">Nome Completo</span>
                                    <input name="user_name" value="" required style="background: #ffffff !important" />
                                </label>
                            </div>
                            <div class="form_group">
                                <label class="form_label">
                                    <span class="label_text" style="margin-bottom: 1.3rem">CPF</span>
                                    <input name="user_document" value="" required style="background: #ffffff !important" />
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form_group">
                        <label class="form_label">
                            ...
                            <input name="user_mail" value="" required style="background: #ffffff !important" />
                        </label>
                    </div>
                    <div class="label_100"></div>
                    ...
                    <div class="form_group">
                        <div class="label_50">
                            <label class="form_label">
                                <span class="label_text">E-mail</span>
                                <input type="email" name="user_mail" value="" required style="background: #ffffff !important" />
                            </label>
                            <label class="form_label">
                                <div class="form_group">

$(function () {
    ...
    //ALL SUPPORT
    $('body').on('click', '.wc_ead_allsupport', function () {
    ...
    //MY SUPPORT
    $('body').on('click', '.wc_ead_mysupport', function () {
        if (!$(this).hasClass('btn_green')) {
            $(this).removeClass('btn_blue').addClass('btn_green');
    ...
    $('body').on('click', '.jwc_ead_task_check', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $('body').on('click', '.jwc_ead_task_uncheck', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $('body').on('click', '.j_wc_ticket_close', function () {
        $('.wc_ead_course_task_modal').fadeOut(200);
    });

    //TASK MANAGER :: OPEN MODAL REPLY
    $('body').on('click', '.jwc_ticket_review', function () {
    ...
    $('body').on('click', '.jwc_ticket_reply', function () {
    ...
    //WC EAD BONUS CLOSE
    $('body').on('click', '.jwc_ead_close_bonus', function () {

...
function wc_tinyMCE() {
    tinyMCE.init({
        ...
        ],//forecolor | backcolor | removeformat |   | strikethrough | alignleft | aligncenter | alignright | fullscreen
        toolbar: "bold | italic | underline",
        content_css: "_css/tinyMCE.css?mx=true",
        style_formats: [

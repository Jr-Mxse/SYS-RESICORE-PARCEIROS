                ...
                <div class="dashboard_header_top">
                    ...
                    <!-- Botão de Troca de Tema -->
                        <div class="dashboard_theme_switcher">
                            <button class="dashboard_btn dashboard_btn_dark" id="dashboardThemeToggle" aria-label="Alternar tema">

                                <i class="ki-duotone ki-sun fs-2 theme-icon" data-theme="light">
                                    <span class="path1"></span><span class="path2"></span><span class="path3"></span>
                                    <span class="path4"></span><span class="path5"></span><span class="path6"></span>
                                </i>
                                
                                <i class="ki-duotone ki-moon fs-2 theme-icon" data-theme="dark" style="display: none;">
                                    <span class="path1"></span><span class="path2"></span>
                                </i>
                                
                                <i class="ki-duotone ki-screen fs-2 theme-icon" data-theme="auto" style="display: none;">
                                    <span class="path1"></span><span class="path2"></span><span class="path3"></span>
                            ...
                            <div class="dashboard_theme_dropdown" id="dashboardThemeDropdown">
                                <ul>
                                    <li data-theme="light" class="theme-option active">
                                        <i class="ki-duotone ki-sun fs-2"></i> Claro
                                    </li>
                                    <li data-theme="dark" class="theme-option">
                                        <i class="ki-duotone ki-moon fs-2"></i> Escuro
                                    </li>
                                    <li data-theme="auto" class="theme-option">
                                        <i class="ki-duotone ki-screen fs-2"></i> Sistema
                                    </li>
                                </ul>
                            </div>
                        </div>

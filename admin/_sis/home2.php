    ...
    <section class="dashboard_section2_container">
        ...
        <div class="dashboard_widget_card">
            ...
            <table class="funnel_table">
                <thead>
                    <tr><th>Etapa</th><th>Qtde</th><th>Situação</th></tr>
                </thead>
                <tbody>
                    <tr><td>Contato / Qualificação</td><td>14</td><td>em atendimento</td></tr>
                    <tr><td>Análise de crédito</td><td>10</td><td>aguardando docs</td></tr>
                    <tr><td>Projeto</td><td>3</td><td>apresentação</td></tr>
                    <tr><td>Contrato</td><td>2</td><td>em assinatura</td></tr>
                </tbody>
            </table>
        </div>
    </section>
    ...
    <section class="dashboard_section3_container">
        ...
        <div class="dashboard_large_card">
            ...
            <div class="chart_container">
                <div class="chart_bar"><div class="bar_column" style="height: 80px;"></div><span class="bar_label">Abr</span></div>
                <div class="chart_bar"><div class="bar_column" style="height: 120px;"></div><span class="bar_label">Mai</span></div>
                <div class="chart_bar"><div class="bar_column" style="height: 110px;"></div><span class="bar_label">Jun</span></div>
                <div class="chart_bar"><div class="bar_column" style="height: 95px;"></div><span class="bar_label">Jul</span></div>
                <div class="chart_bar"><div class="bar_column" style="height: 135px;"></div><span class="bar_label">Ago</span></div>
                <div class="chart_bar"><div class="bar_column" style="height: 160px;"></div><span class="bar_label">Set</span></div>
            </div>
        ...
        <div class="dashboard_large_card">
            ...
            <table class="commission_table">
                <thead><tr><th>Data</th><th>Cliente/Obra</th><th>Status</th><th>Valor</th></tr></thead>
                <tbody>
                    <tr><td>03/09</td><td>Casa — Jardim Aurora</td><td><span class="commission_status status_paga">Paga</span></td><td>R$ 3.200</td></tr>
                    <tr><td>18/09</td><td>Casa — Parque Verde</td><td><span class="commission_status status_paga">Paga</span></td><td>R$ 2.800</td></tr>
                    <tr><td>05/10</td><td>Casa — Vila Real</td><td><span class="commission_status status_prevista">Prevista</span></td><td>R$ 1.900</td></tr>
                    <tr><td>22/10</td><td>Casa — Marapendi</td><td><span class="commission_status status_prevista">Prevista</span></td><td>R$ 5.000</td></tr>
                </tbody>
            </table>
    ...
    <section class="dashboard_section5_container">
        <div class="dashboard_mini_card">
            ...
            <div class="mini_card_content">
                ...
                <div><p class="mini_card_value">6/8</p><p>Conecta & Treinamentos (60 dias)</p></div>
            </div>
        </div>
        ...
        <div class="dashboard_mini_card">
            ...
            <div class="mini_card_content">
                ...
                <div><p class="mini_card_value">23</p><p>Apresentações, roteiros e guias</p></div>
            </div>
        </div>
        ...
        <div class="dashboard_mini_card">
            ...
            <div class="mini_card_content">
                ...
                <div><p class="mini_card_value">48</p><p>feedbacks atualizados (30 dias)</p></div>
            </div>
        </div>
    </section>
    ...
    <section class="dashboard_section6_container">
        <div class="dashboard_table_card">
            ...
            <table class="partners_table">
                <thead><tr><th>Pos.</th><th>Parceiro</th><th>Vendas</th><th>Pontos</th></tr></thead>
                <tbody>
                    <tr><td>1</td><td>Ana Souza</td><td>8</td><td>1.540</td></tr>
                    <tr><td>2</td><td>Carlos Lima</td><td>7</td><td>1.420</td></tr>
                    <tr><td>3</td><td>Você</td><td>6</td><td>1.200</td></tr>
                    <tr><td>4</td><td>Fernanda Alves</td><td>5</td><td>1.050</td></tr>
                    <tr><td>5</td><td>Mariana Rios</td><td>5</td><td>1.000</td></tr>
                    <tr><td>6</td><td>Bruno Castro</td><td>5</td><td>980</td></tr>
                    <tr><td>7</td><td>Luiz Hartmann</td><td>4</td><td>930</td></tr>
                    <tr><td>8</td><td>Carla Moreira</td><td>4</td><td>910</td></tr>
                    <tr><td>9</td><td>Rubens Previato</td><td>3</td><td>860</td></tr>
                    <tr><td>10</td><td>Marcos Silva</td><td>3</td><td>845</td></tr>
                </tbody>
            </table>
        </div>

    ...
    <div class="dashboard_header_search">
        <form name="searchUsers" action="" method="post" enctype="multipart/form-data" class="ajax_off">
            ...
            <select name="opt" style="width: 45%; margin-right: 3px; padding: 5px 10px">
                ...
                <option <?= ($O == 'customers' ? "selected='selected'" : ''); ?> value="customers">Leads</option>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $Users):
            ...
            $user_thumb = ajusteFotoPerfil($user_thumb);
            echo "<article class='single_user box box25 al_center'>
                    ...
                    <div class='single_user_actions'>
                        <a class='btn btn_green icon-user' href='dashboard.php?wc=users/create&id={$user_id}' title='Gerenciar'>Gerenciar</a>
                    </div>
                </article>";
        endforeach;

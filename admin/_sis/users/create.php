...
if ($UserId):
    ...
    if ($Read->getResult()):
        ...
        if ($user_level > $_SESSION['userLoginParceiros']['user_level']):
...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search" style="font-size: 0.875em; margin-top: 16px;" id="<?= $UserId; ?>">
        <span rel='dashboard_header_search' class='j_delete_action icon-warning btn btn_red' id='<?= $UserId; ?>'>Deletar</span>
                   ...
                   <div class="label_50">
                    ...
                    <div class="label_50">
                        <label class="label">
                            ...
                            <input value="<?= $user_telephone; ?>" class="formPhone" type="text" name="user_telephone" />
                        </label>
                    ...
                    <?php if ($user_level < 10 || $_SESSION['userLoginParceiros']['user_level'] == 10): ?>
                        <div class="label_50">
                            <label class="label">
                                ...
                                <select name="user_level" required>
                                    ...
                                    foreach ($NivelDeAcesso as $Nivel => $Desc):
                                        if ($Nivel <= $_SESSION['userLoginParceiros']['user_level']):
                                            echo "<option";
                                            if ($Nivel == $user_level):
                    ...
                    foreach ($Read->getResult() as $Addr):
                        ...
                        echo "<div class='single_user_addr' id='{$Addr['addr_id']}'>
                            ...
                            <div class='single_user_addr_actions'>
                                <a title='Editar endereço' href='dashboard.php?wc=users/address&id={$Addr['addr_id']}' class='post_single_center icon-notext icon-pagebreak btn btn_blue'></a>

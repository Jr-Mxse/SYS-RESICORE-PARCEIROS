    ...
    <div class="login_left">
        <div class="login_content">
            ...
            if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'www.localhost'):
                echo "<img class='login_logo' src='https://ead.resiplace.com.br/_ead/images/logo.svg' alt='ResiPlace' />";
            else:
            ...
            <form class="login_form" name="wc_ead_register" action="" method="post">
                ...
                <input type="hidden" name="callback_action" value="admin_register">

                <div class="form_group">
                    <label class="form_label">
                        <span class="label_text">Nome:</span>
                        <input type="text" name="user_name" placeholder="Informe seu nome completo" required />
                    </label>
                </div>

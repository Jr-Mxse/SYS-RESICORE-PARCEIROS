...
<!-- <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'organizacao/home') ? 'active' : ''; ?>">
 ...
 -->
<li class="dashboard_nav_menu_li has-submenu <?= strstr($getViewInput, 'organizacao/home') ? 'active' : ''; ?>">
    <a href="#" data-tooltip="Portais">
       <i class="icon-office"></i>
        <span class="menu-text">Minhas Empresas</span>
    ...
    <ul class="dashboard_nav_menu_sub">
        <li><a href="dashboard.php?wc=organizacao/home"> Equipe </a></li>
    </ul>
</li>

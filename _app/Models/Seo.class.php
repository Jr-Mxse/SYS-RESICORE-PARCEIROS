 ...
 * 
 * @copyright (c) 2014, Wellington Junior ResiCode
 */
class Seo {
    ...
    private function setPach() {
        ...
        if (in_array($this->File, $Pages)):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'WebSite';
                $this->Title = $Page['page_title'] . " - " . SITE_NAME2;
                $this->Description = $Page['page_subtitle'];
                $this->Image = (!empty($Page['page_cover']) ? BASE2 . "/uploads/{$Page['page_cover']}" : INCLUDE_PATH . '/images/default.jpg');
            else:
                $this->set404();
            endif;
        elseif ($this->File == 'index'):
            //INDEX
            $this->Schema = 'WebSite';
            $this->Title = SITE_NAME2 . " - " . SITE_SUBNAME;
        ...
        elseif ($this->File == 'artigo' && $this->Key == 'amp'):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'WebSite';
                $this->Title = $Post['post_title'] . " - " . SITE_NAME2;
                $this->Description = $Post['post_subtitle'];
                $this->Image = BASE2 . "/uploads/{$Post['post_cover']}";
        ...
        elseif ($this->File == 'artigos'):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'WebSite';
                $this->Title = $Category['category_title'] . " - " . SITE_NAME2;
        ...
        elseif ($this->File == 'pesquisa'):
            //PESQUISA
            $this->Schema = 'WebSite';
            $this->Title = "Pesquisa por {$this->Link} em " . SITE_NAME2;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'conta'):
            ...
            if (ACC_MANAGER):
                ...
                $this->Schema = 'WebSite';
                $this->Title = (!empty($ArrAccountApp[$this->Link]) ? SITE_NAME2 . " - " . $ArrAccountApp[$this->Link] : 'OPPPSSS!');
                $this->Description = SITE_DESC;
                $this->Image = INCLUDE_PATH . '/images/default.jpg';
            else:
                $this->set404();
        ...
        elseif ($this->File == 'produto'):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'Product';
                $this->Title = $Pdt['pdt_title'] . " - " . SITE_NAME2;
                $this->Description = $Pdt['pdt_subtitle'];
                $this->Image = BASE2 . "/uploads/{$Pdt['pdt_cover']}";
            else:
                $this->set404();
            endif;
        elseif ($this->File == 'produtos'):
            ...
            if ($Read->getResult()):
                $Category = $Read->getResult()[0];
                $this->Schema = 'WebSite';
                $this->Title = $Category['cat_title'] . " - " . SITE_NAME2;
                $this->Description = SITE_DESC;
                $this->Image = INCLUDE_PATH . '/images/default.jpg';
            else:
                $this->set404();
        ...
        elseif ($this->File == 'marca'):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'WebSite';
                $this->Title = $Brand['brand_title'] . " - " . SITE_NAME2;
                $this->Description = SITE_DESC;
                $this->Image = INCLUDE_PATH . '/images/default.jpg';
            else:
                $this->set404();
        ...
        elseif ($this->File == 'pedido'):
            //PEDIDO
            $this->Schema = 'WebSite';
            $this->Title = SITE_NAME2 . " - " . ECOMMERCE_TAG;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'imovel'):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'WebSite';
                $this->Title = "{$Imobi['realty_title']} - " . SITE_NAME2;
                $this->Description = Check::Chars($Imobi['realty_desc'], 156);
                $this->Image = BASE2 . "/uploads/{$Imobi['realty_cover']}";
            else:
                $this->set404();
            endif;
        elseif ($this->File == 'imoveis'):
            ...
            $this->Schema = 'WebSite';
            $this->Title = $Link . "Imóveis - " . SITE_NAME2;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'filtro'):
            //FILTRO
            $this->Schema = 'WebSite';
            $this->Title = "Filtrar Imóveis - " . SITE_NAME2;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'campus'):
            switch ($this->Link):
                case '':
                case 'home':
                    if (!empty($_SESSION['userLoginParceiros'])):
                        $this->Title = SITE_NAME2 . " | Minha Conta!";
                    else:
                        $this->Title = SITE_NAME2 . " | Entrar!";
                    endif;
                    break;
                case 'login':
                    $this->Title = SITE_NAME2 . " | Entrar!";
                ...
                case 'senha':
                case 'nova-senha':
                    $this->Title = SITE_NAME2 . " | Recuperar Senha!";
                    break;
                case 'ativar':
                    $this->Title = SITE_NAME2 . " | Ativar Conta!";
                    break;
                case 'curso':
                    $Read->FullRead("SELECT course_title FROM " . DB_EAD_COURSES . " WHERE course_name = :name", "name={$this->Key}");
                    $this->Title = ($Read->getResult() ? "Curso {$Read->getResult()[0]['course_title']}" : "Meu Curso") . " - " . SITE_NAME2 . "!";
                    break;
                case 'tarefa':
                    $Read->FullRead("SELECT class_title FROM " . DB_EAD_CLASSES . " WHERE class_name = :name", "name={$this->Key}");
                    $this->Title = ($Read->getResult() ? "Aula {$Read->getResult()[0]['class_title']}" : "Minha Aula") . " - " . SITE_NAME2 . "!";
                    break;
                case 'imprimir':
                    $this->Title = "Imprimir Certificado | " . SITE_NAME2;
                    break;
                default:
                    $this->Title = SITE_NAME2 . " | " . SITE_SUBNAME;
            endswitch;
        ...
        elseif ($this->File == 'curso'):
            ...
            if ($Read->getResult()):
                ...
                $this->Schema = 'WebSite';
                $this->Title = $Course['course_title'] . " | " . SITE_NAME2;
                $this->Description = $Course['course_headline'];
                $this->Image = BASE2 . "/uploads/{$Course['course_cover']}";
            else:
                $this->set404();
            endif;
        else:

...
if (!empty($_SESSION['userLoginParceiros']) && !empty($_SESSION['userLoginParceiros']['user_id'])):
    ...
    $Read->ExeRead(DB_USERS, "WHERE user_id = :user_id", "user_id={$_SESSION['userLoginParceiros']['user_id']}");
    if ($Read->getResult()):
...
if (APP_POSTS_AMP && (!empty($URL[0]) && $URL[0] == 'artigo') && file_exists(REQUIRE_PATH . '/amp.php') && (!empty($URL[2]) && $URL[2] == 'amp') && (!empty($PostAmp) && $PostAmp == true)):
    ...
    <html lang="pt-br" itemscope itemtype="https://schema.org/<?= $SEO->getSchema(); ?>">
        ...
        <meta name="mit" content="2019-09-17T00:12:51-03:00+17631">
            ...
            <link rel="base" href="<?= BASE2; ?>"/>
            <link rel="canonical" href="<?= BASE2; ?>/<?= $getURL; ?>"/>
            <?php
            if (APP_POSTS_AMP && (!empty($URL[0]) && $URL[0] == 'artigo') && file_exists(REQUIRE_PATH . '/amp.php') && (!empty($PostAmp) && $PostAmp == true)):
                echo '<link rel="amphtml" href="' . BASE2 . '/' . $getURL . '/amp" />' . "\r\n";
            endif;
            ?>
            <link rel="alternate" type="application/rss+xml" href="<?= BASE2; ?>/rss.php"/>
            <link rel="sitemap" type="application/xml" href="<?= BASE2; ?>/sitemap.xml" />
            <?php
            ...
            <meta itemprop="url" content="<?= BASE2; ?>/<?= $getURL; ?>"/>
            ...
            <meta property="og:url" content="<?= BASE2; ?>/<?= $getURL; ?>" />
            <meta property="og:SITE_NAME2" content="<?= SITE_NAME2; ?>" />
            ...
            ?>
            <meta property="twitter:domain" content="<?= BASE2; ?>" />
            ...
            <meta property="twitter:url" content="<?= BASE2; ?>/<?= $getURL; ?>" />           
            ...
            <link rel="stylesheet" href="<?= BASE2; ?>/_cdn/bootcss/reset.css"/>
            <link rel="stylesheet" href="<?= BASE2; ?>/_cdn/bootcss/fonticon.css"/>
            ...
            if (APP_EAD):
                echo '            <link rel="stylesheet" href="' . BASE2 . '/_ead/wc_ead.css"/>' . "\r\n";
            endif;
            ...
            <!--[if lt IE 9]>
                <script src="<?= BASE2; ?>/_cdn/html5shiv.js"></script>
            <![endif]-->

            <script src="<?= BASE2; ?>/_cdn/jquery.js"></script>
            <script src="<?= BASE2; ?>/_cdn/workcontrol.js"></script>
        ...
        <body>        
            ...
            if (ADMIN_MAINTENANCE && !empty($_SESSION['userLoginParceiros']['user_level']) && $_SESSION['userLoginParceiros']['user_level'] >= 6):
            ...
            if (ADMIN_MAINTENANCE && (empty($_SESSION['userLoginParceiros']['user_level']) || $_SESSION['userLoginParceiros']['user_level'] < 6)):
                ...
                if ($Search && !empty($Search['s'])):
                    ...
                    header('Location: ' . BASE2 . '/pesquisa/' . $Search);
                    exit;
                endif;
            ...
            if ($Read->getResult()):
                ...
                foreach ($Read->getResult() as $HomeCodes):
                    ...
                    if (empty($HomeCodes['code_condition'])):
                        ...
                        $Update->ExeUpdate(DB_CODE, $UpdateCodes, "WHERE code_id = :id", "id={$HomeCodes['code_id']}");

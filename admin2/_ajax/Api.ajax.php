    ...
    switch ($Case):
        ...
        case 'license':
            ...
            if (in_array('', $PostData)):
                ...
                try {
                    $PostLicence = file_get_contents("https://download.workcontrol.com.br?k={$PostData['licene_key']}&u={$PostData['user_email']}&p=" . hash('sha512', $PostData['user_password']) . "&v=" . ADMIN_VERSION . "&d=" . urlencode(BASE2));

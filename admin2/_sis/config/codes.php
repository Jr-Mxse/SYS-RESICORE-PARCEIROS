...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-cog">Parceiros Residere Codes</h1>
        <p class="dashboard_header_breadcrumbs">
            &raquo; Parceiros Residere
            <span class="crumb">/</span>
            <a title="Parceiros Residere" href="dashboard.php?wc=config/home">Configurações</a>
            <span class="crumb">/</span>
            Codes
        </p>
    </div>
...
<div class="dashboard_content">
    ...
    <div class="wc_codes_create">
        <form class="wc_codes_create_form" action="" method="post" enctype="multipart/form-data">
            ...
            <p class="wc_codes_create_form_title">Novo Code Parceiros Residere:</p>
            <label>
    ...
    <?php
    $Read->ExeRead(DB_CODE, "ORDER BY code_created DESC");
    if (!$Read->getResult()):

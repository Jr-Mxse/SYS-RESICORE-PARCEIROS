<?php
$AdminLevel = LEVEL_CONFIG_MASTER;
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-embed2">Parceiros Residere® Samples</h1>
        <p class="dashboard_header_breadcrumbs">
            &raquo; Parceiros Residere
            <span class="crumb">/</span>
            <a title="Parceiros Residere" href="dashboard.php">Dashboard</a>
            <span class="crumb">/</span>
    ...
    <div class="box box100">
        ...
        <div class="tab_contents">
                    ...
                    <div class="panel" style="border-radius: 0 0 5px 5px;">
                        <form>
                            <label class="label">
                                ...
                                <input style="" type="text" name="titulo" placeholder="Digite um título" required/>
                            </label>

                            <div class="label_50">
                                <label class="label">
                                    <span class="legend">Campo 1 50%:</span>
                                    <input style="" type="text" name="campo1" placeholder="Digite um título" required/>
                                </label>
                                <label class="label">
                                    <span class="legend">Campo 2 50%:</span>
                                    <input style="" type="text" name="campo2" placeholder="Digite um título" required/>
                                </label>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="label_33">
                                ...
                                <label class="label">
                                    ...
                                    <input style="" type="text" name="campo3" placeholder="Digite um título" required/>
                                </label>
                            </div>
            ...
            <div class="wc_tab_target ds_none" id="icons">
                <link rel="stylesheet" href="<?= BASE2; ?>/_cdn/bootcss/icomoon/demo-files/demo.css"/>
                <div class="box box100">
                    <div class="panel_header default">

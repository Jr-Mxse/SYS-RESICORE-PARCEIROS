...
elseif ($UserId):
    $NewReg = ['user_id' => $UserId, 'addr_name' => 'Novo Endereço'];
    $Create->ExeCreate(DB_USERS_ADDR, $NewReg);
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        ...
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span>
            <a title="Parceiros Residere" href="dashboard.php?wc=users/create&id=<?= $user_id; ?>"><?= "{$user_name} {$user_lastname}"; ?></a>
            <span class="crumb">/</span>
            <?= $addr_name; ?>
        </p>
    </div>
    ...
    <div class="dashboard_header_search" style="font-size: 0.875em; margin-top: 16px;">
        <a class="btn btn_blue icon-undo2" title="Parceiros Residere" href="dashboard.php?wc=users/create&id=<?= $user_id; ?>">Conta de <?= $user_name; ?></a>
    </div>
        ...
        <div class="panel" style="border-radius: 0 0 5px 5px;">
            <form class="auto_save" name="user_add_address" action="" method="post" enctype="multipart/form-data">
                ...
                <label class="label">
                    ...
                    <input name="addr_name"  value="<?= $addr_name; ?>" placeholder="Ex: Minha Casa:" required/>
                </label>

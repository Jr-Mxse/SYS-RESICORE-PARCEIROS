<article class="wc_tab_target wc_active" id="profile">
    ...
    <div class="panel" style="border-radius: 0 0 5px 5px">
        <form class="auto_save" class="j_tab_home tab_create" name="leads_manager" action="" method="post" enctype="multipart/form-data">
            ...
            <label class="label">
                ...
                <input value="<?= $leads_name; ?>" type="text" name="leads_name" required />
            </label>

            <div class="label_33">
                <label class="label labelx_67">
                    <span class="legend">E-mail:</span>
                    <input value="<?= $leads_email; ?>" type="email" name="leads_email" />
                </label>
                <label class="label" id="div_genre">
                    <span class="legend">Gênero do Usuário:</span>
                    <select name="leads_genre" required>
            ...
            <div class="label_33">
                <label class="label" id="div_cpf">
                    ...
                    <input value="<?= $leads_document; ?>" type="text" name="leads_document" class="formCpf" />
                </label>
                <label class="label">
                    <span class="legend" id="txt_niver">Data de Nascimento:</span>
                    <input value="<?= (!empty($leads_datebirth) ? date("d/m/Y", strtotime($leads_datebirth)) : null); ?>" type="text" name="leads_datebirth" class="jwc_datepicker formDate" placeholder="Data de Nascimento:" />
                </label>
                <label class="label">
                    <span class="legend">Celular:</span>
                    <input value="<?= $leads_cell; ?>" class="formPhone" type="text" name="leads_cell" />
                </label>
            </div>

            <label class="label">
                <span class="legend">Observações:</span>
                <textarea name="leads_content" class="work_mce" rows="10"><?= $leads_content; ?></textarea>
            </label>

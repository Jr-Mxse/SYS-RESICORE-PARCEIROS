 ...
 * LOCAL_FILE_BASE2_DIRECTORY = Override the DOCUMENT_ROOT. This is best used in timthumb-config.php
 */
...
class timthumb {
    ...
    protected function calcDocRoot() {
        ...
        if (defined('LOCAL_FILE_BASE2_DIRECTORY')) {
            $docRoot = LOCAL_FILE_BASE2_DIRECTORY;
        }
        if (!isset($docRoot)) {

...
if (!empty($_SESSION['userLoginParceiros'])):
    $wcFbUserSection = array_map("mb_strtolower", $_SESSION['userLoginParceiros']);
...
<script>
    $(function () {
        ...
        //WC TRACK 
        WC_SEGMENT_USER = <?= (!empty(SEGMENT_USER) ? 1 : 0); ?>;
        ...
        <?php if(APP_POSTS == 1): ?>
        //SITE :: ARTIGO
        WC_SEGMENT_BLOG = <?= (!empty(SEGMENT_BLOG) ? 1 : 0); ?>;
        ...
        //E-COMMERCE :: PRODUTO
        WC_SEGMENT_ECOMMERCE = <?= (!empty(SEGMENT_ECOMMERCE) ? 1 : 0); ?>;
        ...
        <?php if(APP_IMOBI == 1): ?>
        //IMOBI :: IMÓVEL
        WC_SEGMENT_IMOBI = <?= (!empty(SEGMENT_IMOBI) ? 1 : 0); ?>;
        ...
        <?php if(APP_EAD == 1): ?>
        //EAD :: CURSO
        WC_SEGMENT_EAD = <?= (!empty(SEGMENT_EAD) ? 1 : 0); ?>;
